"""
Django settings for Watermelons project.
...
SECRET_KEY = 'django-insecure-^)kj4ofx6)6=-(a9nin@21l#-00vameg_-(x3s&b_57v(9fjf@'
...
WSGI_APPLICATION = 'Watermelons.wsgi.application'
